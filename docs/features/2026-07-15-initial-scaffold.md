...
- `tests/`: 24 tests across rep counting, coach, server endpoints, and CLI hook install/uninstall.
...
- First page load fetches the MediaPipe pose model (about 5 MB) from a CDN; cached afterwards.
